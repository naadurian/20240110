...
def get_reviewer(content, keyword, relation, review_org):
    try:
        ...
        review_content = content[content.find(keyword):content.find(keyword)+99]
        # print("--------------")
...
def get_MAN(content, relation):
    try:
        ...
        ## 这里是处理模型连姓都没抽出来的情况 
        job_title = ["助理","老师","先生","女士","小姐","主任","经理","医生","主管","总监","警官","科长","班长","干事","镇长"]
        job_content = content
        #print(job_content)       
...
def get_man_org_old(content):
    ...
    # print("caigou_content:",caigou_content)
    # print("daili_content:",daili_content)
    # print("jiandu_content:",jiandu_content)
    caigou_man =  get_MAN(caigou_content, 1)
    daili_man =  get_MAN(daili_content, 2)
    jiandu_man = get_MAN(jiandu_content, 3)
    # print("caigou_man:",caigou_man)
    # print("daili_man:",daili_man)
    # print("jiandu_man:",jiandu_man)
    for m in caigou_man:
        man.append(m)
    for m in daili_man:
        man.append(m)
    ...
    for review in reviewer:
        if review in content:    
            ...
            #print("pingshen_man:",pingshen_man)
